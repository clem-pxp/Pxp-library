...
export function Monitor({ className = 'size-4' }: MonitorProps) {
  return (
    <svg className={className} viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M5.75 15.75C6.508 15.511 7.628 15.25 9 15.25C9.795 15.25 10.941 15.338 12.25 15.75" stroke="#2E2F30" strokeWidth="1.41" strokeLinecap="round" strokeLinejoin="round" />
